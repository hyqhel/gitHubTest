...
public class ProductSpecificationTest {
    ...
    public void testAddRelatedProdSpec() {
        ...
        Enum returnCode = this.srcProdSpec.addRelatedProdSpec(null, type, validFor);
        ...
        returnCode = this.srcProdSpec.addRelatedProdSpec(targetProdSpec, null, validFor);
        ...
        // *********** Case3 **************
        returnCode = this.srcProdSpec.addRelatedProdSpec(targetProdSpec, type, validFor);
        ...
        returnCode = this.srcProdSpec.addRelatedProdSpec(targetProdSpec2, type, validFor);
        ...
        ProductSpecification targetProdSpec3 = new AtomicProductSpecification("T002", "AppleCare For iPhone2",
                "AppleCare");
        returnCode = this.srcProdSpec.addRelatedProdSpec(targetProdSpec3, type, validFor);
        ...
        ProductSpecification targetProdSpec4 = new AtomicProductSpecification("T001", "AppleCare For iPhone2",
                "AppleCare");
        returnCode = this.srcProdSpec.addRelatedProdSpec(targetProdSpec4, type4, validFor);
        ...
        returnCode = this.srcProdSpec.addRelatedProdSpec(this.srcProdSpec, type4, validFor);
